...
Вариант использования «Отправить уведомление пользователю» предназначен для того, чтобы система оповещений имела возможность с помощью push-уведомления сигнализировать пользователя о задачах с высоким приоритетом либо о задачах, у которых приближается дедлайн.
1. Вариант использования начинается, когда система оповещений начинает анализировать список задач.
2. Система оповещений обращается к базе данных для получения списка задач.
3. База данных возвращает системе оповещений список задач.
4. Система оповещений начинает анализ полученного списка. Если обнаружена задача с высоким приоритетом либо задача, у которой приближается дедлайн, начинает выполняться альтернативный поток А1.
